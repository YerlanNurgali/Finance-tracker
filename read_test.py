...
def test_category_expenses():
    operations = [
        "Расход: -1000 тенге | Категория: Еда",
        "Расход: -2000 тенге | Категория: Транспорт",
        "Расход: -500 тенге | Категория: Еда",
    ]
...
def test_edit_operation():
    ...
    assert operations[0] == (
        "24.08.2026 00:42 | Расход: -2000 тенге | Категория: Развлечения"
    )
